...
//            }
    ...
    public void showNextKnownTipView(){
        mHightLight = new HighLight(K32TongActivity.this)
                .anchor(findViewById(R.id.ac_k3_er_tong_rootview))//rootview
                .addHighLight(R.id.layout_tong_hao,R.layout.info_gravity_left_down,new OnBottomPosCallback(60),new RectLightShape())
                .addHighLight(R.id.layout_bu_tong_hao,R.layout.info_gravity_left_down,new OnBottomPosCallback(60),new RectLightShape())
                .addHighLight(R.id.layout_fu_xuan,R.layout.info_gravity_left_down,new OnBottomPosCallback(60),new RectLightShape())
                .autoRemove(false)
                .enableNext()

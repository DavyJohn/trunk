...
public class FCZxTuTenFragment  extends BaseFragment{
    private static final String TAG = FCZxTuTenFragment.class.getSimpleName();
    @Bind(R.id.fc_zx_tu_ten_tcvg)
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fc_zx_tu_ten_layout,container,false);
    }

...
public class FCZxTuUnitFragment extends BaseFragment {
    private static final String TAG =FCZxTuUnitFragment.class.getSimpleName();
    @Bind(R.id.fc_zx_tu_unit_tcvg)
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fc_zx_tu_unit_layout,container,false);
    }

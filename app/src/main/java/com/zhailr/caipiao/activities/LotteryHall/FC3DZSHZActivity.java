 ...
 */
public class FC3DZSHZActivity extends BaseActivity {
    private static final String TAG = "FC3DZSHZActivity";
    @Bind(R.id.tv_time)
    TextView tvTime;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getToolBar().setTitle(R.string.fc3d_zshz_paly);
        getCurrentNum();
        initUI();
        initIntent();
        shake();
        ...
        mText.setText("猜中开奖号相加之和即奖346元");
        mFolatButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Constant.CHOOSE_STYLE = 4;
                Constant.isClick = true;
                startActivity(new Intent(FC3DZSHZActivity.this,ShakeActivity.class));
            }
        });
    }
            ...
            case R.id.tv_clear:
                if (tvClear.getText().equals("机选")) {
                    DialogPlus dialog = DialogPlus.newDialog(this)
                            ...
                            .setAdapter(new SimpleAdapter(FC3DZSHZActivity.this, true))

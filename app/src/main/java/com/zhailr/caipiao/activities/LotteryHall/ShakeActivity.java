...
public class ShakeActivity extends BaseActivity implements SensorEventListener {
    ...
    private static final int CHOOSE = 0x4;
    private static final int START = 0x5;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getToolBar().setTitle("摇一摇");
        MyApplication.getInstance().add(this);
        chooseList = (ArrayList<BetBean>) getIntent().getSerializableExtra("data");
        //设置只竖屏
                ...
                Thread thread = new Thread() {
                    ...
                    public void run() {
                        ...
                        try {
                            ...
                            Thread.sleep(500);
                            mHandler.obtainMessage(CHOOSE).sendToTarget();
 ...
 *
 * * 给下一批的 开发者的告示：
 * 由于这个项目进过最起码两个人了 摇杆监听有两种
 * 由于本人不想改 我也写了一个 只要轻轻一摇会导致两种监听只会触发其中一个（这是一个小问题 只要重写其中一种就好了）
 * （其实就是想贪多需要两种 呵呵！！！）
 * */
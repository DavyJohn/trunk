 ...
 */
public class MySecKeyboardView extends SecKeyboardView {
    ...
    private EditText ed;
    private OnFinishedClickListener mOnFinishClickListener;

    public void setOnFinishClickListener(OnFinishedClickListener onItemClickListener) {
        this.mOnFinishClickListener = onItemClickListener;
    }
    ...
    public MySecKeyboardView(Activity act, final EditText editText, KeyboardView keyboardView) {
        super(act, editText, keyboardView);
        this.mActivity = act;
        this.ed = editText;
        this.mKeyboardView = keyboardView;

        k1 = new Keyboard(mActivity, com.kejiwen.securitykeyboardlibrary.R.xml.qwerty);
        k2 = new Keyboard(mActivity, com.kejiwen.securitykeyboardlibrary.R.xml.symbols);
        ...
        public void onKey(int primaryCode, int[] keyCodes) {
            ...
            if (primaryCode == Keyboard.KEYCODE_CANCEL) {// 完成
                if (mOnFinishClickListener != null) {
                    mOnFinishClickListener.onItemClick();
                }

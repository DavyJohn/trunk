 ...
 */
public class K3RecordAdpter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private Context mContext;
    private List<KSRecordResponse.DataBean.HitoryQSBean> mData;
    private OnItemClickListener mOnItemClickListener;
    private OnTipClickListener mOnTipClickListener;

    public K3RecordAdpter(Context context) {
        this.mContext = context;
    }


    public void setData(List<KSRecordResponse.DataBean.HitoryQSBean> data) {
        this.mData = data;
        this.notifyDataSetChanged();
    }


    public KSRecordResponse.DataBean.HitoryQSBean getItem(int position) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.adpter_k3_record, parent, false);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof ItemViewHolder) {
            ...
            KSRecordResponse.DataBean.HitoryQSBean bean = mData.get(position);
            if (bean == null) {
                return;
            }

 ...
 */
public class FC3DGroupActivity extends BaseActivity {
    private static final String TAG = "FC3DGroupActivity";
    @Bind(R.id.tv_time)
    TextView tvTime;
    @Bind(R.id.layout_ball_chong)
    LinearLayout layoutBallChong;
    @Bind(R.id.layout_ball_dan)
    LinearLayout layoutBallDan;
    @Bind(R.id.tv_clear)
    TextView tvClear;
    @Bind(R.id.tv_zhu)
    TextView tvZhu;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mFloatButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Constant.CHOOSE_STYLE = 2;
                Constant.isClick = true;
                startActivity(new Intent(FC3DGroupActivity.this,ShakeActivity.class));
...
//        }
    ...
    private void initUI() {
        ...
        int redNum = 10;
        int layoutwidth = layoutBallChong.getWidth();
    ...
    private void initBallView(int redNum, int margin, int diameter, int layoutwidth) {
        ...
        // 画重位红球的view
        drawBallView(col, redRow, diameter, margin, redNum, "1", layoutBallChong);
        // 画单位红球的view
        drawBallView(col, redRow, diameter, margin, redNum, "2", layoutBallDan);
...
//                }, 2000);
    ...
    private void clickRedBall(TextView view, String tag) {
        if (view.getTag() == null || view.getTag() == "0") {
            ...
            if (tag.equals("1")) {
                if (mRedList1.size() != 0) {
                    TextView textView = mRedClickList1.get(0);
                    textView.setTag(1);
                    textView.setTextColor(getResources().getColor(R.color.red));
                    textView.setBackground(getResources().getDrawable(R.drawable.whiteball));
                    mRedList1.remove(textView.getText().toString());
                    mRedClickList1.remove(textView);
                }
                if (mRedList2.size() != 0 && mRedList2.get(0).equals(view.getText().toString())) {
                    TextView textView = mRedClickList2.get(0);
                    textView.setTag(1);
                    textView.setTextColor(getResources().getColor(R.color.red));
                    textView.setBackground(getResources().getDrawable(R.drawable.whiteball));
                    mRedList2.remove(textView.getText().toString());
                    mRedClickList2.remove(textView);
                }
                ...
                if (mRedList1.size() != 0 && mRedList1.get(0).equals(view.getText().toString())) {
                    TextView textView = mRedClickList1.get(0);
                    textView.setTag(1);
                    textView.setTextColor(getResources().getColor(R.color.red));
                    textView.setBackground(getResources().getDrawable(R.drawable.whiteball));
    ...
    private static List<String> getIntersection(List<String> list1,
                                                List<String> list2) {
...
//            }
            ...
            case R.id.tv_clear:
                if (tvClear.getText().equals("机选")) {
                    DialogPlus dialog = DialogPlus.newDialog(this)
                            ...
                            .setAdapter(new SimpleAdapter(FC3DGroupActivity.this, true))
    ...
    public void showNextKnownTipView(){
        mHightLight = new HighLight(FC3DGroupActivity.this)
                .anchor(findViewById(R.id.ac_fc3d_group_rootview))
                .addHighLight(R.id.layout_ball_chong,R.layout.info_gravity_left_down,new OnBottomPosCallback(60),new RectLightShape())
                .addHighLight(R.id.layout_ball_dan,R.layout.info_gravity_left_down,new OnBottomPosCallback(60),new RectLightShape())
                .autoRemove(false)
                .enableNext()
